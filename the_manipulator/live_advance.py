...
def main():
    ...
    your_app_client_id = 'wlN8UgoObQRu76N4sCqQL7rtLcoA76XkC4IAE4hs'
    your_app_client_secret = 'Zpb7QVqJpGKlgXsHkoIWQGGfxjSpfmcoVK0XjIMpzyfdi2XhXrF5fAGqxPotJIgpGgSzg5Qf5ubhC9IDzNdaWg82W8A5ibOntdA5wokl0BiEcwkK21OmBX9OD8dCKn6G'

    # Init live advance
    l = LiveAdvance(your_app_client_id, your_app_client_secret)

    trained_profile_name = 'newvaroo' # Please set a trained profile name here
